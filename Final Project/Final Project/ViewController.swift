...
class ViewController: UIViewController {
    ...
    let rankingView = RankingView() // Ranking screen
    ...
    override func viewDidLoad() {
        ...
        // Navigation to RankingView
        loginView.viewRankingButton.addTarget(self, action: #selector(showRanking), for: .touchUpInside)
